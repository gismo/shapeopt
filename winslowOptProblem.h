#ifndef winslowOptProblem_H
#define winslowOptProblem_H
...
class winslowOptProblem: public paraOptProblem {
public:
  winslowOptProblem(gsMultiPatch<>* mpin):paraOptProblem(mpin){};
