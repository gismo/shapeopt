...
OUT="output.txt";
BS="/";
BASE_FOLDER="../results/OptParam3D/"
...
do
    ...
    #   #
    #   #(time ./main -r $R -e $e --optParamXML --startFile "parametrizations/XML/water_passage_fixed.xml" -d $dim -o "${FOLDER}"
    #   #) |& tee "${FOLDER}$BS$OUT"; 
    ...
    do
       ...
       (time ./main -r $R -e $e --decreasingTau --decrTauFactor 0.25 --optParamXML --startFile "parametrizations/XML/water_passage_fixed.xml" -d $dim -o "${FOLDER}"
       ) |& tee "${FOLDER}$BS$OUT"; 
    done
done
